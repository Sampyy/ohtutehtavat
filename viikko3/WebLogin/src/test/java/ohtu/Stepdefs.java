...
public class Stepdefs {
    ...
    @When("nonexisting username {string} and any password {string} are given")
    public void correctUsernameAndAnyPasswordAreGiven (String username, String password) {
        logInWith(username, password);
    }
    ...
    public void validUsernameAndPasswordAndConfirmationGiven (String username, String password) {
        createAccountWith(username, password, password);
    }
    ...
    public void invalidUsernameAndAPassword(String username, String password){
        createAccountWith(username, password, password);  
    }
    ...
    public void validUsernameAndAnInvalidPasswordGiven(String username, String password){
        createAccountWith(username, password, password);
    }
    
    @When ("a valid username {string} and a valid password {string} and different confirmation {string} are entered")
    public void validUsernameAndNoMatchingPasswords(String username, String password, String passwordConfirmation) {
